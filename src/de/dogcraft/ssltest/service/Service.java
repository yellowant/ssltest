...
public class Service extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		if (path == null || path.equals("/")) {
			...
			resp.setDateHeader("Last-Modified", ManagementFactory
					.getRuntimeMXBean().getStartTime());
			copyStream(Service.class.getResourceAsStream("../res/index.htm"),
	...
	private void stream(HttpServletRequest req, HttpServletResponse resp,
			boolean useEventStream) throws IOException {
		if (useEventStream) {
	...
	private void testBugs(TestImplementationBugs b, TestOutput ps)
			throws IOException {
		b.testBug(ps);
	...
	private void determineCiphers(TestOutput ps, TestCipherList c)
			throws IOException {
