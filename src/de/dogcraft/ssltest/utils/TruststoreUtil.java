...
public class TruststoreUtil {
    ...
    private static void readPems(String pem, String store) throws IOException, InterruptedException {
        ...
        while ((s = br.readLine()) != null) {
            ...
            if (cert) {
                ...
                if (s.startsWith("-----END CERTIFICATE--")) {
                    cert = false;
                    out.close();
                    BufferedReader err = new BufferedReader(new InputStreamReader(keytool.getErrorStream()));
        ...
        for (File file : data) {
            ...
            while (al.hasMoreElements()) {
                ...
                if (pubk instanceof RSAPublicKey) {
                    int pub = ((RSAPublicKey) pubk).getPublicExponent().intValue();
                    if (pub == 3) {
